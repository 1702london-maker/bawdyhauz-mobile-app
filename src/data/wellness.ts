...
export const therapists: TherapistProfile[] = [
  {
    ...
    qualifications: ["UKCP registered placeholder", "Relationship therapy specialist", "Private practice background"],
    sessionApproach:
  ...
  },
  {
    ...
    qualifications: ["Certified coaching placeholder", "Communication facilitation", "Couples support background"],
    sessionApproach:
  ...
  },
  {
    ...
    qualifications: ["Wellness practitioner placeholder", "Conflict navigation", "Private client work"],
    sessionApproach:
