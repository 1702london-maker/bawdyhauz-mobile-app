  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        ...
        Matches area. Video introductions and concierge care open as the conversation matures.
      </Body>
      ...
      <LuxuryCard style={styles.card}>
        ...
        <Body>
          Keep the first exchange intentional. Video introductions become available after a
          thoughtful private conversation has had time to develop.
        </Body>
      </LuxuryCard>
