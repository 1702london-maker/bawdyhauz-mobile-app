  ...
  return (
    <View>
      ...
      <LuxuryCard style={styles.card}>
        <Caption>Typing status · read receipts prepared</Caption>
        {messages.length === 0 ? (
          <PlaceholderPanel
        ...
        <View style={styles.attachmentRow}>
          <AttachmentPill label="Image prepared" />
          <AttachmentPill label="Voice note prepared" />
          <AttachmentPill label="Safety review active" />
        </View>
        <FormField
          label="Message"
    ...
    <Modal transparent visible={visible} animationType="fade" onRequestClose={onClose}>
      <View style={styles.modalBackdrop}>
        <LuxuryCard style={styles.modalCard}>
          ...
          <Body>
            Choose a proposed time. The private video room will be prepared once both members
            confirm.
          </Body>
          <FormField
