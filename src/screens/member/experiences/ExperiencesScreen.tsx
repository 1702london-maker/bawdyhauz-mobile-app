...
function ExperienceList({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Review private invitations, request access and join waitlists for discreet member
        experiences.
      </Body>
...
function RsvpFlow({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Request access to {experience.title}. The member services team will review fit, space and
        guest tone before confirming.
      </Body>
...
function WaitlistFlow({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Join the waitlist for {experience.title}. Availability is manually reviewed by the member
        services team.
      </Body>
...
function ExperienceConfirmation({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Your request for {experience.title} has been received for member services review.
      </Body>

      <PlaceholderPanel
        label={label}
        title={status === "waitlisted" ? "Waitlist confirmation" : "Invite pending"}
        copy="This status is pending private confirmation and does not yet guarantee admission."
        style={styles.card}
      />
...
function QrTicketPlaceholder({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Present this access card at arrival only after your invitation has been confirmed by the
