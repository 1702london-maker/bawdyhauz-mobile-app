  ...
  return (
    <View>
      ...
      {completion ? (
        <LuxuryCard style={styles.card}>
          ...
          {completion.missingItems.length ? (
            ...
            <Caption style={styles.message}>Your profile is ready for refined curation.</Caption>
          )}
        </LuxuryCard>
      ) : null}
      ...
      <LuxuryCard style={styles.card}>
        ...
        <Body>
          Private gallery images are not public. Access is reviewed carefully and never opened by
          default.
        </Body>
