  ...
  return (
    <View>
      ...
      <View style={styles.imagePlaceholder}>
        ...
        <Caption>Portrait placeholder</Caption>
      </View>
...
function BookingFlow({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Submit a local booking request for {therapist.name}. Payment, calendar sync and video
        calls are intentionally not connected yet.
      </Body>
...
function BookingConfirmation({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Your request with {therapist.name} has been recorded locally. Future builds will route this
        through member services and therapist availability review.
      </Body>
      ...
      <LuxuryCard style={styles.card}>
        ...
        <Body>
          Preferred date: {booking.date}. Preferred time: {booking.time}. Confirmation remains a
          placeholder until scheduling infrastructure is added.
        </Body>
      </LuxuryCard>
...
function WellnessResources({ onBack }: { onBack: () => void }) {
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Placeholder editorial resources for emotional guidance, relationship preparation,
