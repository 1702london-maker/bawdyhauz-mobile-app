...
function PostDateReview({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        After a completed date, both members submit private feedback for human-led review,
        safety learning and better future introductions.
      </Body>
...
function ReportConfirmation({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Your report for {reason} has been received by the BAWDYHAUZ safety process for private
        human review.
      </Body>
...
function IncidentStatusScreen({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Your report can move through report received, under review, action taken and closed.
      </Body>
      <PlaceholderPanel
        ...
        style={styles.card}
      />
      <LuxuryButton onPress={onNextStatus}>Update review status</LuxuryButton>
    </View>
  );
}
...
function UserStandingScreen({
  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Standing reflects internal safety review. Account action remains human-led.
      </Body>
      <View style={styles.chips}>
