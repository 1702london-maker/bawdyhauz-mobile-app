  ...
  return (
    <View>
      ...
      <Body style={styles.copy}>
        Membership tiers define access, priority and concierge depth. Billing is handled privately
        and will be confirmed through secure member services.
      </Body>
      ...
      <LuxuryCard style={styles.card}>
        ...
        <Body>Status: active, cancelled, expired and past due states are supported for member care.</Body>
      </LuxuryCard>
      ...
      {plans.map((plan) => (
        <LuxuryCard key={plan.id} style={styles.card}>
          ...
          >
            {subscription.tier === plan.tier ? "Current tier" : "Request tier change"}
          </LuxuryButton>
        </LuxuryCard>
      ))}
